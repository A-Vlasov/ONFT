...
/**
 Example:
 hh ragnarok-transform:set-ragnarok-address \
   --address 0x5FbDB2315678afecb367f032d93F642f64180aa3 \
   --network sepolia
 */
task("ragnarok-transform:set-ragnarok-address", "Set ragnarok address")
	.addParam<string>("address", "Address of ragnarok contract")
