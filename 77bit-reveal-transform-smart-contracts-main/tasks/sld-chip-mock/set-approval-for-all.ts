...
/**
 Example:
 hh sld-chip-mock:set-approval-for-all --operator 0x55B454d00F11DDf55BFA7b50CDE6816850cB5be8 --approve true  --network sepolia
 */
task("sld-chip-mock:set-approval-for-all", "Calls setApprovalForAll")
