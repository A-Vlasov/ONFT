...
pub mod ONft {
    ...
    // ============================== ONFT additions ==============================
    pub fn quote_onft(ctx: Context<QuoteOnftMsg>, params: QuoteOnftMsgParams) -> Result<MessagingFee> {
        QuoteOnftMsg::apply(&ctx, &params)
    }

    pub fn send_onft(mut ctx: Context<SendONft>, params: SendONftParams) -> Result<MessagingReceipt> {
        SendONft::apply(&mut ctx, &params)
    }

    pub fn lz_receive_onft(mut ctx: Context<LzReceiveONft>, params: LzReceiveParams) -> Result<()> {
        LzReceiveONft::apply(&mut ctx, &params)
    }
